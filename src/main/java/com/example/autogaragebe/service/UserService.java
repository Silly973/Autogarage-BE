...
import com.example.autogaragebe.dto.UsertDto;
import com.example.autogaragebe.exeption.BadRequestException;
import com.example.autogaragebe.exeption.InvalidPasswordException;
import com.example.autogaragebe.exeption.NotAuthorizedException;
import com.example.autogaragebe.exeption.UserNotFoundException;
import com.example.autogaragebe.model.Authority;
import com.example.autogaragebe.model.User;
import com.example.autogaragebe.repository.UserRepository;
...
public class UserService {
    ...
    public String createUser(UsertDto usertDto) {
        try {
            String encryptedPassword = passwordEncoder.encode(usertDto.getPassword());

            User user = new User();
            user.setUsername(usertDto.getUsername());
            user.setPassword(encryptedPassword);
            user.setEmail(usertDto.getEmail());
            user.setEnabled(true);
            user.addAuthority("ROLE_USER");
            for (String s : usertDto.getAuthorities()) {
